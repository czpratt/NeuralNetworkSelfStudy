''' A good checkpoint, because we're now going to implement the feed forward part of the transformer '''
...
class BigramLanguageModel(nn.Module):
    ...
    def __init__(self):
        ...
        ### Commenting out for now as we're implementing the block structure of the transformer
